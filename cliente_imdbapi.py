...
async def search_title_imdbapi(cliente, title):
  async with cliente:
      ...
      #resumo = await cliente.call_tool('details_title', arguments={"id_title_imdb": resultado['id']})
      ...
      Retorne as informações encontradas em {resultado[0].text} de forma organizada e legível. 
      """
